...
/* [Spike - section that will be burried underground] */
spike_length = 100;
spike_radius = 7.5;
...
module draw_lid_text() {
  ...
  zmove(lid_text_depth / 2.1) path_text(
      text_path, "* ANTS BE GONE * GEL - GRANULAR - ANT BAIT STATION",
