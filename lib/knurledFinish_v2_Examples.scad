...
/* ******************************************************************************
 */
// Example 02: Changing the Height and the Outer Diameter from the default
// values.
//
...
/* ******************************************************************************
 */
// Example 03: Not intended to be printed but to be used in a boolean
// difference.
...
module knurl_example_04() {
  ...
  es = 2;  // Default Ends Smoothing value used by 'knurl()' in the library.
           //		(this is also the half of the knurl height so the
           //"bevel"
...
module knurl_example_05() {
  ...
  difference() {
    ...
    translate([ 0, 0, -es / 2 ]) knurl(e_smooth = -es);
  }
}
...
//					This time we use the new inner suface
// finish that applies 					the bevel and the
// surface smooth in a different way.
//
